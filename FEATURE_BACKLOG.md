...
| Disc universe: full ingestion pipeline (1F) | IN PROGRESS | B1.7 remote adapter/server-ingestion design approved; implementation remains gated: user-provided URL hints, raw payload staging, dedup review queue, open-dataset check, image URLs only, and polite crawling |
